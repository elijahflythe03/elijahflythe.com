...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Conducted a NASA-funded research initiative assessing cybersecurity resilience of critical water and wastewater infrastructure against cyber-physical attacks; evaluated widely deployed IIoT devices and SCADA architectures to identify systemic vulnerabilities, including legacy systems with outdated security controls, default credential usage, and unpatched long-standing CVEs, and leveraged these findings to develop mitigative and preventative controls that strengthened system resilience and security hygiene.",
